 ...
 * @Description: Java 运行状况
 * @Date: Created in 11:13  2018/6/27
 */
public class JavaService {

    private static final Properties props = System.getProperties(); //系统属性
     ...
     * 获取系统参数
     *
     * @return Properties props （） props.getProperty("java.version")
     */
